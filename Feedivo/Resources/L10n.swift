...
enum L10n {
    ...
    static let readerDisplayModeReadability = LocalizedStringKey("reader.displayMode.readability")
    static let readerDisplayModeWeb = LocalizedStringKey("reader.displayMode.web")
    static let readerReadabilityIdleTitle = LocalizedStringKey("reader.readability.idle.title")
    static let readerReadabilityIdleDescription = LocalizedStringKey("reader.readability.idle.description")
    static let readerReadabilityLoading = LocalizedStringKey("reader.readability.loading")
    static let readerReadabilityLoadingDescription = LocalizedStringKey("reader.readability.loading.description")
    static let readerReadabilityLoaded = LocalizedStringKey("reader.readability.loaded")
    static let readerReadabilityFailed = LocalizedStringKey("reader.readability.failed")
    ...
    static let ruleWizardRegexHelpButton = LocalizedStringKey("ruleWizard.regexHelp.button")
    static let ruleWizardRegexHelpTitle = LocalizedStringKey("ruleWizard.regexHelp.title")
    static let ruleWizardRegexHelpIntro = LocalizedStringKey("ruleWizard.regexHelp.intro")
    static let ruleWizardRegexHelpDot = LocalizedStringKey("ruleWizard.regexHelp.dot")
    static let ruleWizardRegexHelpAny = LocalizedStringKey("ruleWizard.regexHelp.any")
    static let ruleWizardRegexHelpDigit = LocalizedStringKey("ruleWizard.regexHelp.digit")
    static let ruleWizardRegexHelpWhitespace = LocalizedStringKey("ruleWizard.regexHelp.whitespace")
    static let ruleWizardRegexHelpStart = LocalizedStringKey("ruleWizard.regexHelp.start")
    static let ruleWizardRegexHelpEnd = LocalizedStringKey("ruleWizard.regexHelp.end")
    static let ruleWizardRegexHelpExamplesTitle = LocalizedStringKey("ruleWizard.regexHelp.examples.title")
    static let ruleWizardRegexHelpExampleSwift = LocalizedStringKey("ruleWizard.regexHelp.example.swift")
    static let ruleWizardRegexHelpExampleBreaking = LocalizedStringKey("ruleWizard.regexHelp.example.breaking")
    ...
    static let settingsSyncStatusDatabaseError = LocalizedStringKey("settings.sync.status.databaseError")
    static let settingsSyncStatusActive = LocalizedStringKey("settings.sync.status.active")
    static let settingsSyncStatusLocal = LocalizedStringKey("settings.sync.status.local")
    static let settingsSyncStatusRestartEnable = LocalizedStringKey("settings.sync.status.restartEnable")
    static let settingsSyncStatusRestartDisable = LocalizedStringKey("settings.sync.status.restartDisable")
