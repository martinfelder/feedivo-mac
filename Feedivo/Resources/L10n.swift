...
enum L10n {
    ...
    static let settingsFeedsNotifySelected = LocalizedStringKey("settings.feeds.notifySelected")
    static let settingsFeedsUnnotifySelected = LocalizedStringKey("settings.feeds.unnotifySelected")
    ...
    static let versionHistorySectionTitle = LocalizedStringKey("versionHistory.window.title")
