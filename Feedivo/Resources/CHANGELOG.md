...
- Verbesserung: Neue, spürbar flüssigere Artikelliste ist jetzt standardmäßig
  aktiv (inkl. mehrerer kleinerer Nachbesserungen bei Zeilenumbrüchen,
  Trennlinien und der Darstellung der Zusammenfassung)
- Fehlerbehebung: Absturz behoben, der beim Scrollen auftreten konnte, wenn
  die Bildvorschau in der Artikelliste ausgeschaltet war
- Verbesserung: Artikel werden nach dem Auswählen spürbar schneller im
  Lesebereich angezeigt
- Verbesserung: Artikel ohne eigenes Bild im Feed werden nicht mehr
  künstlich mit einem von der Originalseite nachgeladenen Bild ergänzt —
  die Ansicht entspricht jetzt genau dem, was der Feed liefert
