...
- Die kompakte Artikelsuche sitzt in einer eigenen Section oben im
  Detailbereich. Sie bleibt sichtbar, wenn eine Feed-/Tag-/Smartfolder-Liste
  aktiv ist, auch ohne Artikelauswahl, und filtert diese Liste über den
  SQLite/FTS-Pfad. Die frühere große Suchmaske wurde aus der Artikelliste
  entfernt, damit die mittlere Spalte leicht bleibt.
...
- 2026-07-04: Phasen 2, 3, 4, 7 und 9 wurden erfolgreich abgeschlossen.
  ...
  `ArticleListSnapshot`s. Die kompakte Suche im Detailbereich nutzt den
...
- 2026-07-05: Kompakte Artikelsuche in eine eigene Section im Detailbereich
  verschoben. Das Suchfeld bleibt dadurch auch ohne Artikelauswahl sichtbar; die
  Artikelliste selbst bleibt frei von Such-Chroming und erhält den Suchtext als
  Binding aus `ContentView`.
